...
class ANN(object):
    ...
    def fit(self, X, Y, activation=T.nnet.relu, learning_rate=1e-3, mu=0.0, reg=0, epochs=10000, batch_sz=None, print_period=500, show_fig=True):
        X , Y = shuffle(X,Y)
        ...
        for i in range(epochs):
            ...
            for j in range(n_batches):
                ...
                if (i+1) % print_period == 0:
                    print("i:", i+1, "cost:", c , "score:",np.mean(Y==p))
